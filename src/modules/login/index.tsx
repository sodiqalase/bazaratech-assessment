...
const LoginView = () => {
	...
	const { isValid, errors, touched, getFieldProps, handleSubmit, dirty } = form;
	...
	return (
		<AuthLayout>
			<section className="bg-white flex w-[90vw] sm:w-[400px] items-center flex-col gap-y-6 rounded-[20px] px-6 py-[60px] shadow-[0px_8px_16px_0px_#0000000A]">
				...
				<h3 className="text-baz-black font-bold text-2xl">Login to your account</h3>
				<form onSubmit={handleSubmit} className="flex flex-col gap-y-4 w-full">
					...
					<div>
						...
						<div className="mt-1 flex justify-end items-center">
							<Link href="#" className="text-xs text-baz-primaryBlue700 mt-1">
								Forgot password?
							</Link>
						</div>
					</div>
